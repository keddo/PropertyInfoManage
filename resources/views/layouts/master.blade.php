...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{'img/logo.png'}}" alt="Adu Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Adigrat University</span>
    </a>
  ...
  <footer class="main-footer text-center">
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="https://www.adu.edu.et">Adigrat University</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
